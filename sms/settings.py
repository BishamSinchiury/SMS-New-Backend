...
env_file = BASE_DIR / ('.env.production' if ENVIRONMENT == 'prod' else '.env.development')
...
MIDDLEWARE = [
    ...
    'Users.middleware.ProfileStatusMiddleware',
...
AI_SERVICE_PROVIDER = config('AI_SERVICE_PROVIDER', default='mock')  # 'mock', 'openai', 'huggingface'
